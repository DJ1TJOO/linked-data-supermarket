...
const { data: mostSoldProducts, isValidating: isMostSoldProductsValidating, mutate: mutateMostSoldProducts } = useMostSoldProducts(limit)
const { data: highestTurnoverProducts, isValidating: isHighestTurnoverProductsValidating, mutate: mutateHighestTurnoverProducts } = useHighestTurnoverProducts(startDate, endDate, limit)
const { data: highestTurnoverVegetables, isValidating: isHighestTurnoverVegetablesValidating, mutate: mutateHighestTurnoverVegetables } = useHighestTurnoverVegetables(startDate, endDate, limit)
const { data: bestPerformingCategories, isValidating: isBestPerformingCategoriesValidating, mutate: mutateBestPerformingCategories } = useBestPerformingCategories(startDate, endDate, limit)
const { data: highestLossRateProducts, isValidating: isHighestLossRateProductsValidating, mutate: mutateHighestLossRateProducts } = useHighestLossRateProducts(limit)
const { data: highestLossCostProducts, isValidating: isHighestLossCostProductsValidating, mutate: mutateHighestLossCostProducts } = useHighestLossCostProducts(startDate, endDate, limit)
const { data: productSales, isValidating: isProductSalesValidating, mutate: mutateProductSales } = useProductSales(startDate, endDate, limit)
const { data: productHealthBenefits, isValidating: isProductHealthBenefitsValidating, mutate: mutateProductHealthBenefits } = useProductHealthBenefits(limit)
